...
function parseInline(inlineItem, BlockEntities, BlockStyles) {
  ...
  return { content: content, blockEntities: blockEntities, blockEntityRanges: blockEntityRanges, blockInlineStyleRanges: blockInlineStyleRanges };
}
...
function markdownToDraft(string) {
  ...
  var md = new Remarkable(remarkablePreset, remarkableOptions);
